  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      <motion.div
        ...
        onViewportEnter={() => setSelectedPage('главная')}
      >
        {/* MAIN HEADER */}
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            ...
            <p className="mt-8 text-sm">
              Тренажерный зал. Непревзойденные тренировки и фитнес.
              Студии мирового класса, в которых можно получить тело, о котором вы мечтаете. Получите тело своей мечты прямо сейчас.
            </p>
          </motion.div>
